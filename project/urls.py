...
from project.views import listProjects, saveProject, viewProject, editProject, delete
from django.contrib.auth.decorators import login_required

urlpatterns = [
    
    path('', login_required(listProjects, login_url='loginView') , name='projects'),
    path('<int:page>/', login_required(listProjects, login_url='loginView'), name='projects'),
